...
public enum GoalSuccessCode implements BaseSuccessCode {
    ...
    GOAL_LIST_FETCHED(HttpStatus.CREATED, "GOAL200_1", "목표 목록 조회 성공"),
    GOAL_DETAIL_FETCHED(HttpStatus.CREATED, "GOAL200_2", "목표 상세 조회 성공"),
    GOAL_UPDATED(HttpStatus.CREATED, "GOAL200_3", "목표가 성공적으로 수정되었습니다."),
    GOAL_DELETED(HttpStatus.CREATED, "GOAL200_4", "목표가 성공적으로 삭제되었습니다."),
