...
public enum GoalErrorCode implements BaseErrorCode {
    ...
    ACCOUNT_NOT_FOUND(HttpStatus.NOT_FOUND, "GOAL404_2", "계좌를 찾을 수 없습니다."),
    GOAL_ALREADY_LINKED_ACCOUNT(HttpStatus.BAD_REQUEST, "GOAL400_1", "해당 목표는 이미 계좌가 연결되어 있습니다."),
    ACCOUNT_ALREADY_LINKED_TO_GOAL(HttpStatus.BAD_REQUEST, "GOAL400_2", "해당 계좌는 이미 다른 목표에 연결되어 있습니다."),
