...
public enum Organization {
    ...
    GYEONGNAM_BANK("0039", "경남은행", BusinessType.BK),
    KFCC("0045", "새마을금고", BusinessType.BK),
    CU("0048", "신협은행", BusinessType.BK),
    POST_OFFICE("0071", "우체국", BusinessType.BK),
    HANA_BANK("0081", "KEB하나은행", BusinessType.BK),
    SHINHAN_BANK("0088", "신한은행", BusinessType.BK),
    K_BANK("0089", "K뱅크", BusinessType.BK),

    // 카드 (03번대)
    KB_CARD("0301", "KB카드", BusinessType.CD),
    HYUNDAI_CARD("0302", "현대카드", BusinessType.CD),
    SAMSUNG_CARD("0303", "삼성카드", BusinessType.CD),
    NH_CARD("0304", "NH카드", BusinessType.CD),
